...
RSpec.describe User, type: :model do
  ...
  describe '.authenticate_with_credentials' do
    ...
    it 'should return user instance even if types in the wrong case for email' do
      user = User.create(name: "Test Name", email: "test4@test.com", password: "test_password", password_confirmation: "test_password")
      result = User.authenticate_with_credentials("TeSt4@tEsT.CoM", user.password)
      expect(result).not_to be_nil
